          ...
          <div class="right-box">
            ...
            <div class="nav-aside">
              ...
              <div class="user pr">
                ...
                <div class="nav-user-wrapper pa" v-if="this.token !==null" >
              ...
              <!-- 购物车 -->
              <div class="shop pr" @mouseenter="moveShowCart(true)" @mouseleave="moveShowCart(false)">
                  ...
                  <div class="nav-user-list">
                    <div class="full">
                              ...
                              <div class="cart-item-inner">
                                <a>
                                  <div class="item-thumb">
                                    <img src='../../public/static/images/smile.png' />
                                  </div>
                                  <div class="item-desc">
                                    <div class="cart-cell">
                                      <h4>
                      ...
                      <div class="nav-cart-total">
                        <p>
                          共
                          <strong>11</strong> 件商品
                        </p>
                        <h5>
                          合计：
                          <span class="price-icon">¥</span>
                          <span class="price-num">1119</span>
                        </h5>
                        <h6>
                    ...
                    <!-- <div style="height: 313px;text-align: center" class="cart-con" v-if="show">
                      <p >您的购物车竟然是空的!</p>
                    </div> -->
                      <el-card class="items">
                        <div class="item" v-for="(item,index) in cartlist" :key="index">
                          ...
                          <div class="right">
                           ...
                           <div class="delbtn">
                             <el-button type="danger" circle size="mini" icon="el-icon-delete" @click="removeGoods"></el-button>
                            </div>
                        </div>
                      </el-card>
                  </div>
...
export default {
  ...
  computed: {
    ...mapState(['login', 'userInfo', 'showCart', 'cardList'])
  },
  methods: {
   ...
   async getCartList() {
      ...
      console.log(res);
      this.cartlist = res.data.cartList.cartList
    }
  },
  created () {
    this.getCartList()
