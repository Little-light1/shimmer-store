      ...
      <section class="w mt30 clearfix" v-if="item.type===2">
        <MShelf :title="item.name">
          <div slot="content" class="hot">
            <MallGoods v-for="(o,index) in item.panelContents" :key="index" :goods="o"></MallGoods>
          </div>
        </MShelf>
      </section>
      <section class="w mt30 clearfix" v-if="item.type===3">
        <MShelf :title="item.name">
          <div slot="content" class="floors">
            <template v-for="(o,index) in item.panelContents">
              <div class="imgbanner" :key="index"  v-if="o.type!==0">
                <img :src="o.picUrl" />
              </div>
            </template>
            <template v-for="(o,index) in item.panelContents">
              <MallGoods :key="index" v-if="o.type===0" :goods="o"></MallGoods>
            </template>
          </div>
        </MShelf>
      </section>
...
export default {
  ...
  methods: {
    async getBannerList () {
      ...
      this.bannerlist = res.result[0].panelContents
    }
  }
}
</script>
